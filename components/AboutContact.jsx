      ...
      <div className="container">
        ...
        <div className="contact-grid">
          <div className="contact-info">
            ...
            <a className="contact-row" href="tel:+5548996894967">
          ...
          <form className="contact-form" onSubmit={submit}>
            ...
            <div className="form-row">
              <div className="field">
                <label>{t('fName')}</label>
                <input type="text" required value={state.name} onChange={upd('name')} placeholder={t('phName')}/>
              </div>
              <div className="field">
                <label>{t('fEmail')}</label>
                <input type="email" required value={state.email} onChange={upd('email')} placeholder={t('phEmail')}/>
              </div>
            </div>
            ...
            <div className="form-row">
              <div className="field">
                ...
                <input type="tel" value={state.phone} onChange={upd('phone')} placeholder={t('phPhone')}/>
              </div>
              <div className="field">
                <label>{t('fTopic')}</label>
                <select value={state.topic} onChange={upd('topic')}>
                  <option value="project">{t('optProject')}</option>
                  <option value="job">{t('optJob')}</option>
            ...
            <div className="form-row">
              <div className="field full">
                <label>{t('fMsg')}</label>
                <textarea required value={state.message} onChange={upd('message')} placeholder={t('phMsg')}/>
              </div>
            </div>
            ...
            <div className={`form-success ${sent ? 'show' : ''}`}>{t('sentMsg')}</div>
          </form>
        </div>
      </div>
    </section>
