  ...
  return (
    <div className="orb">
      <span
        ...
        style={{
          color: "#fff",
          fontSize: `calc(clamp(46px, 6vw, 78px) * ${scale})`,
        }}
      >
        {f.short}
      </span>
        ...
        <div className="hero-grid">
          <div>
            ...
            <div className="stats">
              ...
              <div className="stat">
                <div className="k">{t("statFullK")}</div>
                <div className="v">{t("statFull")}</div>
              </div>
              <div className="stat">
                <div className="k">{t("statLocK")}</div>
                <div className="v">{t("statLocation")}</div>
              </div>
            </div>
          </div>
          ...
          <div className="hero-visual">
            ...
            <div className="chip-ring">
              <span className="chip c-ts">
                <span className="dot"></span>TypeScript
              </span>
              <span className="chip c-react">
                <span className="dot"></span>React
              </span>
              <span className="chip c-next">
                <span className="dot"></span>Next.js
              </span>
              <span className="chip c-node">
                <span className="dot"></span>Node.js
              </span>
              <span className="chip c-pg">
                <span className="dot"></span>PostgreSQL
              </span>
              <span className="chip c-html">
                <span className="dot"></span>HTML
              </span>
              <span className="chip c-css">
                <span className="dot"></span>CSS
              </span>
              <span className="chip c-vitest">
                <span className="dot"></span>Vitest
              </span>
            </div>
          </div>
        </div>
